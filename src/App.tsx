    ...
    <>
      <div className="relative">
        <div className="">
          ...
          >
            <SwiperSlide>
              <img className="home-banner" src={BannerBgc} alt="BannerBgc" />
              <div className="home-banner-mock"></div>
            </SwiperSlide>
            <SwiperSlide>
              <img className="home-banner" src={BannerBgc2} alt="BannerBgc2" />
              <div className="home-banner-mock"></div>
            </SwiperSlide>
            <SwiperSlide>
              <img className="home-banner" src={BannerBgc3} alt="BannerBgc3" />
              <div className="home-banner-mock"></div>
            </SwiperSlide>
          </Swiper>
          <Header />
